...
PROJECT_NAME="base-platform-chart" # name of the platform Helm chart
PROJECT_ABBR="bp" # abbrevention for the platform-name
...
function install_chart {
    ...
    --set-string global.preinstall_extensions[0].name="kaapana-plugin-chart" \
    --set-string global.preinstall_extensions[0].version="0.1.1" \
