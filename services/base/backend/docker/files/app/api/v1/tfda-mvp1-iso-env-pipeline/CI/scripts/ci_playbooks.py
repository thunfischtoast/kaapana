...
def copy_data_algo(target_hosts, bucket_name, chart_path, chart_filename):
    ...
    return_value, logs = ci_playbook_execute.execute(playbook_path, testsuite=suite_name, testname="Copy Data and Algorithm to Isolated Environment", hosts=target_hosts, extra_vars=extra_vars)
    return return_value, logs
